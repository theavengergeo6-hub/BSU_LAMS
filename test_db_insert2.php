...
$stmt = $con->prepare("INSERT INTO lab_reservations (reservation_no, user_name, user_email, user_contact, subject, course_section, station, batch, reservation_date, reservation_time) VALUES ('LAB-TEST-005', 'Test', 'test@test', '123', 'subj', 'cs', '1', '1', '2026-10-10', '07:00 AM')");
try {
    $stmt->execute();
