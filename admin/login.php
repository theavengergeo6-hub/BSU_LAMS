...
<head>
    ...
    <title>Admin Login Panel - KTERS</title>
    ...
    <div class="login-card-container">
        <div class="login-card bg-white p-0">
            <div class="login-header">
                ...
                <p class="mb-0 mt-2 text-white-50 z-1 position-relative">BatStateU ARASOF-Nasugbu Kitchen Tools and Equipment Requisition System</p>
            </div>
        <div class="p-4">
